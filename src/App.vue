...
import { generateDataVisualCode } from './utils/exporter.js'
        ...
        <div class="flex-1 overflow-hidden flex flex-col md:flex-row min-h-0">
          ...
          <div class="flex-1 overflow-auto p-8 bg-slate-50/50 min-w-0" :class="showPreview ? 'md:w-1/2' : 'w-full'">
            ...
            <div class="relative group">
              <pre class="bg-slate-900 p-6 rounded-2xl border border-slate-800 text-[13px] font-mono overflow-auto whitespace-pre-wrap text-blue-300 shadow-inner text-left">{{ generatedCode }}</pre>
              <button
